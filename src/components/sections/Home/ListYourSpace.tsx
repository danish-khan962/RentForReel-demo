...
const ListYourSpace = () => {
    ...
    return (
        <section className='max-w-[1440px] w-full mx-auto relative flex justify-center items-center px-4 sm:px-6 md:px-8 mt-[140px] sm:mt-[160px] md:mt-[180px] lg:mt-[200px]'>
            <div className='max-w-[1500px] w-full rounded-xl bg-[#EEEEEE] flex flex-col xl:flex-row p-5 sm:p-8 md:p-12 lg:p-14 gap-x-0 gap-y-10'>
                ...
                <div className='flex flex-col justify-start items-start'>
                    ...
                    <div className='flex flex-col mt-[30px] sm:mt-[37px]'>
                        <h1 className='font-semibold text-[50px] sm:text-[72px] md:text-[84px] lg:text-[96px]'>
                    ...
                    <Link href={"/"} className='mt-[30px] sm:mt-[35px] md:mt-[42px] lg:mt-[52px]'>
                        <button className='w-[288px] h-[55px] sm:w-[450px] sm:h-[70px] lg:w-[480px] lg:h-[70px] bg-[#D9D9D9] rounded-full border border-[#929292] cursor-pointer font-medium text-[14px] sm:text-base md:text-[18px] lg:text-[20px] text-[#2C2C2C] hover:bg-[#2C2C2C] hover:text-[#FFFFFF] transition-colors ease-in-out duration-200 active:bg-[#2C2C2C] active:text-[#FFFFFF]'>
                            List Your Space Now.
                        </button>
                    </Link>
                </div>

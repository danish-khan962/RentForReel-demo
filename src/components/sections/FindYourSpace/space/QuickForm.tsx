...
const QuickForm = () => {
    ...
    return (
        <div className='max-w-[1500px] w-full mx-auto bg-[#FFFFFF] rounded-2xl border border-[#2C2C2C] flex flex-col xl:flex-row justify-between gap-x-[20px] gap-y-[60px] items-center lg:items-start px-4 sm:px-6 py-2.5'>
            ...
            {/* Left Content Block (Responsive Alignment: Centered on Mobile, Left on Large Screens) */}
            ...
            {/* Right Form Block (Responsive Padding and Alignment) */}
            <form 
            ...
            >
                <p className='font-semibold text-[#BA181B] text-[20px] sm:text-[22px] md:text-[23.5px] lg:text-[25px] text-center'> Quick From </p>
                ...
                <div className='w-full flex flex-col gap-[30px] mt-[29px]'>
                    ...
                    <div className='flex flex-col sm:flex-row justify-center items-center gap-[15px] sm:gap-x-[25px] md:gap-x-[30px] lg:gap-x-[35px]'>
                        {/* Changed this row to stack inputs on small mobile screens (flex-col) and then go back to side-by-side (sm:flex-row) */}
